...
@Repository
public class RsMapLibDao extends BaseIbatis3Dao<RsMapLib,java.lang.String>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RsMapLib entity) {
	...
	public Page findPage(RsMapLibQuery query) {
		return pageQuery("RsMapLib.findPage",query);
	}
