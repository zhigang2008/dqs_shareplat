...
<body>
	...
	<s:form id="myForm" action="/cms/CmsBoard/update.do" method="post">
...
<!-- ONGL access static field: @package.class@field or @vs@field -->
	...
	<tr>	
		...
		<td>
		  <s:select label="留言类别" key="msgType" value="%{model.msgType}" cssClass="digits " list="%{baseCode.cmsBoardType}" listKey="code" listValue="name" />
	    </td>
	</tr>
	...
	<tr>	
		...
		<td>
		  <s:select label="状态" key="status" value="3" cssClass="required digits " list="%{baseCode.cmsBoardStatus}" listKey="code" listValue="name" />
	    </td>
	</tr>
	<tr>	
		<td class="tdlabel">
		...
		<td>
		  <s:textarea label="回复" key="reply" value="%{model.reply}" cssClass="" required="false" rows="6" cssStyle="width:500px;"/>
	    </td>
	</tr>
		</table>
		</div>
