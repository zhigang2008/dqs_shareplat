...
<!-- Header -->
	...
	<s:form action="/cms/CmsBoardStatus/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/cms/CmsBoardStatus/list.do'" >
