...
<!-- Header -->
	...
	<s:form action="/system/UserRole/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/system/UserRole/list.do'" >
