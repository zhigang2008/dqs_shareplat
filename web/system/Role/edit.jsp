      ...
      //产生tabs
       ...
       function initNodeStatus(){
           <s:iterator value="model.roleModules" id="m" status="sm">
    	    $("#moduleTree").dynatree("getTree").getNodeByKey("<s:property value="#m.moduleCode" />").select(); 
    	   </s:iterator>
    	}
</script>
<style >
...
<body>
	...
	<s:form  id="myForm" action="/system/Role/update.do"  method="post">
     ...
     doubleList="%{notExistPermissions}"
     doubleListKey="id"
