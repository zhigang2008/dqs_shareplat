...
<body>
	...
	<s:form id="myForm" action="/system/User/update.do" method="post">
		...
		<p>角色信息:</p>
		 <div><s:checkboxlist name="roleIds" list="%{baseCode.role}" listKey="roleId" listValue="roleName"></s:checkboxlist></div>
		</div>
	</s:form>
	</div>
	<!-- footer -->
