...
<!-- Header -->
	...
	<s:form action="/system/Audit/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/system/Audit/list.do'" >
		...
		<table id="formtable" class="formtable">
			...
			<tr>	
				<td class="tdlabel">登录时间: </td>	
				<td><s:property value="%{model.actTimeString}" /></td>
			</tr>
			<tr>	
				<td class="tdlabel">登录ip: </td>	
				<td><s:property value="%{model.actIp}" /></td>
			</tr>
			<tr>	
				<td class="tdlabel">登录状态: </td>	
				<td><s:property value="%{model.actStatus}" /></td>
			</tr>
			<tr>	
				<td class="tdlabel">操作类型: </td>	
				<td><s:property value="%{model.actType}" /></td>
			</tr>
			<tr>	
