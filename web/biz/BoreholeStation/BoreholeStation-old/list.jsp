		...
		<table width="100%"  border="0" cellspacing="0" class="gridBody">
		  <thead>
			  <tr>
				...
				<th sortColumn="ITEM_CODE" >观测项代码</th>
				<th sortColumn="ITEM_CNAME" >观测项</th>
				<th>操作</th>
			  </tr>
		  </thead>
		  <tbody>
		      <c:choose>
			   ...
			   <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td><c:out value='${item.itemCname}'/>&nbsp;</td>
				<td>
					<a href="${ctx}/biz/BoreholeStation/show.do?id=${item.id}&" title="查看" > <img src="<c:url value='/image/form/view.png'/>" alt="查看"  /></a>&nbsp;
					<wylb:hasPermission name="BoreholeStation:edit">
					<a href="${ctx}/biz/BoreholeStation/edit.do?id=${item.id}&" title="修改" > <img src="<c:url value='/image/form/edit.gif'/>" alt="修改"  /></a>
					</wylb:hasPermission>
				</td>
			  </tr>
		  	  </c:forEach>
