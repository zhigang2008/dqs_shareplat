...
<body>
	...
	<s:form id="myForm" action="/biz/RsMapLib/update.do" method="post">
		...
		<s:hidden id="mapCount" name="mapCount" value="%{model.mapCount}"/>
		<s:hidden id="createTimeString" name="createTimeString" value="%{model.createTimeString}"/>
...
<!-- ONGL access static field: @package.class@field or @vs@field -->
	<tr>	
		...
		<td>
		  <s:textfield label="图库名称" key="mapLibName" value="%{model.mapLibName}" cssClass="required " required="true" />
	    </td>
	</tr>
	<tr>	
		<td class="tdlabel">
		...
		<td>
		  <s:textfield label="说明文件" key="descFileName" id="descFileName" value="%{model.descFileName}" cssClass="" required="false" readOnly="readOnly"/>
		  <s:hidden  key="descFileLocation" id="descFileLocation" value="%{model.descFileLocation}"  />
		  <br/>
